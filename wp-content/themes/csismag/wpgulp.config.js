...
module.exports = {
  // Project options.
  projectURL: 'csismag.local', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
  ...
  // Translation options.
  textDomain: 'csismag', // Your textdomain here.
  translationFile: 'csismag.pot', // Name of the translation file.
  translationDestination: './languages', // Where to save the translation files.
  packageName: 'CSIS iLab', // Package name.
  bugReport: 'https://github.com/CSIS-iLab/csismag_wp', // Where can users report bugs.
