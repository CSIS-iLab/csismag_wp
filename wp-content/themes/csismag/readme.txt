...
CSIS Mag WordPress Theme, Copyright 2019 WordPress.org
CSIS Mag is distributed under the terms of the GNU GPL.
...
CSIS Mag is derived from the Chaplin Theme, Copyright 2019 Anders Norén
Chaplin Theme is distributed under the terms of the GNU GPL version 2.0

CSIS Mag bundles the following third-party resources:
...
Bespoke Icons Created For CSIS Mag
License: Creative Commons Zero (CC0), https://creativecommons.org/publicdomain/zero/1.0/
...
- CSISMag_SVG_Icons
- csismag_the_theme_svg()
- csismag_get_theme_svg()
- csismag_nav_menu_social_icons()
