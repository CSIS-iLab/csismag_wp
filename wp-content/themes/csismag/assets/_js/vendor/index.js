    ...
    modals.forEach(function(modal) {
      ...
      modal.addEventListener("toggle-target-after-inactive", function(event) {
        ...
        setTimeout(function() {
          ...
          _win.scrollTo(
            0,
            Math.abs(_win.csismag.scrolled + getAdminBarHeight())
          );
  ...
  performToggle: function(element, instantly) {
    ...
    if (target.classList.contains(activeClass)) {
      ...
      target.dispatchEvent(
        csismag.createEvent("toggle-target-before-inactive")
      );
    }
    ...
    setTimeout(function() {
      ...
      target.dispatchEvent(csismag.createEvent("toggled"));
      ...
      if (target.classList.contains(activeClass)) {
        ...
        target.dispatchEvent(
          csismag.createEvent("toggle-target-after-inactive")
        );
      }
    }, timeOutTime);
  },
